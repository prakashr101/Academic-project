    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
         ...
         <h2 data-aos="fade-up"  style="  white-space:nowrap;" ><a href="graph1.jsp">Result of Number of the attribute</a></h2>
         <h2 data-aos="fade-up"  style="  white-space:nowrap;"  ><a href="graph2.jsp">Result of Count of download</a></h2>
        </div>
